...
class SwipeHelperCallback : ItemTouchHelper.Callback() {
    ...
    private fun clampViewPositionHorizontal(
        ...
        Log.d("////", "clampViewPositionHorizontal: DX/3 - CLAMP ${dX/3 - clamp}")
        Log.d("////", "clampViewPositionHorizontal: DX - CLMAP ${dX - clamp}")
        Log.d("////", "clampViewPositionHorizontal: -CLAMP ${-clamp}")
        Log.d("////", "clampViewPositionHorizontal: NEWX $newX")
